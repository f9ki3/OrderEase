            ...
            <div class="col-12 col-md-4 mt-5 py-5">
                <div class="d-flex flex-column justify-content-center text-center align-items-center">
                    ...
                    <div class="mt-5">
                        ...
                        <input class="mt-2 p-2 w-100 rounded border" type="text" placeholder="Username or Email" required>
                        <label for="" class="text-start">Password</label>
                        <input class="mt-2 p-2 w-100 rounded border" type="text" placeholder="Password" required>
                        <button class="mt-2 p-2 w-100 rounded border border-primary btn btn-primary">Login</button>
                    </div>
